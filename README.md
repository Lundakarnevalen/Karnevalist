...
4.  Setup `prettier-atom` by changing the following settings:
    ...
    * Only format if prettier is found in your project's dependencies: `true` (optional)

#### b. Install Visual Code

1.  Install [Visual Code](https://code.visualstudio.com/)
2.  Install [prettier plugin](https://github.com/prettier/prettier-vscode)
3.  Setup `prettier-vscode` by changing the following settings:
    * ESLint Integration: `true`
    * Format Files on Save: `true`
    * Only format if prettier is found in your project's dependencies: `true` (optional)

#### c. Install Sublime (not optimal)

1.  Install [Sublime](https://www.sublimetext.com/)
2.  Follow [this guide](http://slashwhatever.com/code/leveraging-prettier-eslint-sublime/) and tell us if it works
