...
class JodelThread extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [{time:'47', place:'Lundagård', grade:'12', onPress:() => {}, text:strings.Placeholder, nbr:'1', color:'#F7A021'}, {time:'2', place:'Delphi', grade:'22', onPress:() => {}, text:strings.Placeholder, nbr:'2', color:'#F7A021'}]
    };
  }
