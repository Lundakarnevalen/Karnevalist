...
export const TREASURE_HUNT_SCREEN_STRINGS = {
  ...
  info: {
    SE: 'Välkommen till vår skattjakt! INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO INFO',
  ...
  firstBody: {
    SE: 'Lundakarnevalen anordnar en skattjakt där deltagarna letar sig igenom lund för att hitta den hemliga plats där Sture gömt sig. De första 25 kommer få ett pris!',
    EN: 'Lundakarnevalen arranges a treasure hunt where the contestans compete to find Sture, who is hiding at a the (top) secret location. The first 25 to find him will recieve a special prize!'
  },
  secondHeader: {
  ...
  secondBody: {
    SE: 'Se till att du har igång GPS, vrid sen din mobil i olika riktningar and lägg märke till när den vibrerar. Detta betyder att den hemliga platsen är åt det hållet!',
    EN: 'Ensure your location sensor is on, then turn your phone various directions and notice when it vibrates. That means the secret location is that way!',
  },
  thirdHeader: {
    SE: 'Och sen då?',
    EN: 'And then what?'
